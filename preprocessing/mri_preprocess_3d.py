...
def main(temp_img, T2W_dir, output_path):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--temp_img", type=str, required=True, help="Path to the atlas template image (e.g., T1/T2).")
    parser.add_argument("--T2W_dir", type=str, required=True, help="Path to the source images directory.")
    parser.add_argument("--output_path", type=str, required=True, help="Path to the preprocessed output directory.")

    args = parser.parse_args()

    # Main function call 
    main(temp_img=args.temp_img, T2W_dir=args.T2W_dir, output_path=args.output_path)
